 ...
 * @internal    @properties &move_tv=TV tab;list;true,false;false;;Transform TV section to a tab. &move_content=Content tab;list;true,false;false;;Transform Content-section to a tab. &use_cm=Order tabs by category rank;list;true,false;false;;If you are using MODX older than 1.2 you will need to install CategoriesManager module https://github.com/pmfx/CategoriesManager to use it, or an error will occur. NOTE: Since MODX 1.2 there is no need to install module as it is built-in into system.
